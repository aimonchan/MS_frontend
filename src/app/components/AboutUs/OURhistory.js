...
const OURhistory = () => {
  ...
  return (
    <section id="history" className="px-2 md:px-0 pb-16 border border-grayborder mt-[10px] mx-[5px] md:mx-[17.5px] mb-4 relative rounded-[20px] bg-black overflow-hidden flex flex-col items-center text-white">
