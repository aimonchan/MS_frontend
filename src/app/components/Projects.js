...
const Hero = () => {
  ...
  const handleClick = () => {
    ...
    return (
        <section
            className="border border-grayborder mt-[20px] mx-[17.5px] relative top-0 left-0 right-0 rounded-[20px] xl:h-[781px] lg:h-[781px] md:h-[140px] sm:h-[85px] xl:flex xl:flex-col items-center justify-center overflow-hidden bg-black py-4"
        >
            {/* Background image */}
            <div
