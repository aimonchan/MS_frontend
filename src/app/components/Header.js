  ...
  return (
    <div>
      ...
      <header
        ...
        fixed top-0 left-0 right-0 z-50 mt-[10px] mx-[17.5px] rounded-tr-[20px] rounded-tl-[20px] border xl:h-[140px] lg:h-[140px] md:h-[140px] sm:h-[85px] xl:flex transition-all duration-300`}
      >
